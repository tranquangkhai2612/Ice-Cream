...
const TableList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/Recipe`);
...
//     return response;
//   } catch (error) {
//     console.error("Error splitting recipe:", error);
//   }
// }
  ...
  const columns = [
    ...
    columnHelper.accessor("recipeName", {
      id: "recipeName",
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">Recipe Name</p>
      ),
      cell: (info) => (
    ...
    columnHelper.accessor("recipeDescription", {
    ...
    // columnHelper.accessor("recipeImage", {
    //   id: "recipeImage",
    //   header: () => (
    //     <p className="text-sm font-bold text-gray-600 dark:text-white">
    //       Recipe Image
    ...
    //   cell: (info) => (
    //     <p className="text-sm font-bold text-navy-700 dark:text-white">
    //       <img src={`https://localhost:7054/${info.getValue()}`} alt="RecipeImage" />
    //     </p>
    //   ),
    // }),
    // columnHelper.accessor("recipeThumbnail", {
    //   id: "recipeThumbnail",
    //   header: () => (
    //     <p className="text-sm font-bold text-gray-600 dark:text-white">
    //       Recipe Thumbnail
    ...
    //   cell: (info) => (
    //     <p className="text-sm font-bold text-navy-700 dark:text-white">
    //       <img src={`https://localhost:7054/${info.getValue()}`} alt="RecipeThumbnail" />
    //     </p>
    //   ),
    // }),
    columnHelper.accessor("recipeIngredient", {
      id: "recipeIngredient",
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">
          Recipe Ingredient
      ...
      cell: (info) => (
        <p className="text-sm font-bold text-navy-700 dark:text-white" style={truncateStyle}>
          {/* {handleSplit(info.getValue().toString()).map((item) => (
              <li>{item}</li>
          ))} */}
          {info.getValue()}
        </p>
    ...
    columnHelper.accessor("recipeSteps", {
      id: "recipeSteps",
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">
          Recipe Steps
    ...
    columnHelper.accessor("recipeProcedures", {
      id: "recipeProcedures",
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">
          Recipe Procedures
    ...
    columnHelper.accessor("recipeDate", {
        id: "recipeDate",
        header: () => (
          <p className="text-sm font-bold text-gray-600 dark:text-white">
            CreateAt
      ...
      cell: (info) => {
        ...
        return (
          <div className="flex space-x-2">
            <Link to={`/admin/edit-recipe/${rowId}`}>
